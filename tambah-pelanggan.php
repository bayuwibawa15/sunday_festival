				...
				<section class="section">
					<div class="section-header">
						...
						<div class="section-header-breadcrumb">
							...
							<div class="breadcrumb-item">Tambah Data Pelanggan</div>
						</div>
					</div>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" name="nama_pelanggan" id="nama_pelanggan" class="form-control" required="" autocomplete="off" placeholder="Nama Pelanggan" autofocus>
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label for="alamat_pelanggan">Alamat Pelanggan</label>
														<input type="text" name="alamat_pelanggan" id="alamat_pelanggan" class="form-control" autocomplete="off" placeholder="Alamat Pelanggan" >
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label for="nomor_pelanggan">Nomor Telpon</label>
														<input type="text" name="nomor_pelanggan" id="nomor_pelanggan" class="form-control" autocomplete="off" placeholder="Nomor Telpon" >
													</div>
												</div>
											</div>
