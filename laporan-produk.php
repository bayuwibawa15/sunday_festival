				...
				<section class="section">
					<div class="section-header">
						...
						<div class="section-header-breadcrumb">
							...
							<div class="breadcrumb-item">Laporan Produk Terlaris</div>
						</div>
					</div>
									...
									<div class="card-body">
										...
										<div class="tab-content" id="myTabContent">
											<div class="tab-pane fade" id="perhari" role="tabpanel"
												...
												<div class="row">
													<div class="col-md-12">
														<form target="_blank" action="cetak-produk" method="POST"
															id="form_tambah">
												...
												<div class="row">
													<div class="col-md-12">
														<form target="_blank" action="cetak-produk" method="POST"
															...
															<div class="col-md-6">
													<div class="form-group">
														<label for="nama_toko">Data Toko</label>
															<?php
														$sql =  "SELECT * FROM tb_toko ORDER BY nama_toko ASC";
														?>
														<select class="form-control select2" name="nama_toko" id="nama_toko" required="" style="width: 100%;">
												...
												<div class="row">
													<div class="col-md-12">
														<form target="_blank" action="cetak-produk" method="POST"
															...
															<div class="col-md-6">
													<div class="form-group">
														<label for="nama_toko1">Data Toko</label>
															<?php
														$sql =  "SELECT * FROM tb_toko ORDER BY nama_toko ASC";
														?>
														<select class="form-control select2" name="nama_toko" id="nama_toko1" required="" style="width: 100%;">
															<option value="">Pilih Data Toko</option>															<option value="Semua Toko">Semua Toko</option>
															<?php
															$result = mysqli_query($conn, $sql);
															while ($data1 = mysqli_fetch_array($result)){
