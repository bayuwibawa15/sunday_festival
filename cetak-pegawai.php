...
#########################################################*/
   $cetak = 'Tanggal Di Cetak : '.tglIndonesia(date('d-F-Y'));
		...
		$filter='Semua Pegawai Toko';
		$query = mysqli_query($conn, "SELECT * FROM tb_pegawai, tb_toko WHERE tb_toko.id_toko=tb_pegawai.id_toko ORDER BY nama_pegawai ASC");
		}else{
		$filter='Pegawai Toko';
		$query = mysqli_query($conn, "SELECT * FROM tb_pegawai, tb_toko WHERE tb_toko.id_toko=tb_pegawai.id_toko AND tb_pegawai.id_toko='$id_toko' ORDER BY nama_pegawai ASC");
		}
...
$tbl2 = '<table border="0">
		...
		<table border="0" style="text-align:center;">
			<tr>
				<td colspan="2" style="text-align:center;"><font size="12em"><b>LAPORAN PEGAWAI</b></font></td>
			</tr>
		</table>
		<br><br>
		';
				...
				$tbl2 = $tbl2.'<table border="1px" cellpadding="2" cellspacing="0">
					<tr style="text-align:center;vertical-align:middle;">
									<th style="width:50px;border: 1px solid #000;">No</th>
													...
													<th style="width:200px;border: 1px solid #000;">Alamat Pegawai</th>
													<th style="width:100px;border: 1px solid #000;">Nomor Telpon</th>
													<th style="width:260px;border: 1px solid #000;">Dari Toko</th>
					</tr>';
					$no = 1;
					while ($tampil = mysqli_fetch_array($query)){
						...
						$tbl2 = $tbl2.'<tr style="text-align:center;">
									...
									<td align="left">'.$tampil['alamat_pegawai'].'</td>
									<td align="center">'.$tampil['nomor_pegawai'].'</td>
