											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" name="keterangan_modal" id="keterangan_modal" class="form-control" required="" autocomplete="off" placeholder="Keterangan" >
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label for="jumlah_modal">Jumlah Modal</label>
														<input type="text" name="jumlah_modal" id="jumlah_modal" class="form-control" required="" autocomplete="off" placeholder="Jumlah Modal">
													</div>
												</div>
											</div>
