				...
				<section class="section">
					<div class="section-header">
						...
						<div class="section-header-breadcrumb">
							...
							<div class="breadcrumb-item">Tambah Data Merk</div>
						</div>
					</div>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" name="nama_merk" id="nama_merk" class="form-control" required="" autocomplete="off" placeholder="Nama Merk" >
													</div>
												</div>
											</div>
