											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" name="nama_produk" id="nama_produk" class="form-control" required="" autocomplete="off" placeholder="Nama Produk" autofocus>
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label for="harga_pembelian">Harga Pembelian</label>
														<input type="text" name="harga_pembelian" id="harga_pembelian" class="form-control" required="" autocomplete="off" placeholder="Harga Pembelian">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label for="harga_penjualan">Harga Penjualan</label>
														<input type="text" name="harga_penjualan" id="harga_penjualan" class="form-control" required="" autocomplete="off" placeholder="Harga Penjualan">
													</div>
												</div>
 												<div class="col-md-6">
													<div class="form-group">
														<label for="stok_produk">Stok Produk</label>
														<input type="number" name="stok_produk" id="stok_produk" class="form-control" required="" autocomplete="off" placeholder="Stok Produk">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														...
														<div class="custom-file">
															<input type="file" class="custom-file-input" id="file1" name="file1" required=""  accept="image/*">
															<label class="custom-file-label" for="file1">Upload Gambar</label>
														</div>
													</div>
												</div>
											</div>
